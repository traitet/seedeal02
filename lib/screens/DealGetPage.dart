...
// MAIN CLASS
//==========================================================================
class DealGetPage extends StatefulWidget {
  @override
  _DealGetPageState createState() => _DealGetPageState();
}

//==========================================================================
// STATE CLASS
//==========================================================================
class _DealGetPageState extends State<DealGetPage> {
  @override
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        RaisedButton(color:Colors.pink, onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context) => PaymentMethodPage()),);}, child: Text('Book Now',style: TextStyle(fontSize: 14, color: Colors.white),))
                      ],
                    ),
                  ),
