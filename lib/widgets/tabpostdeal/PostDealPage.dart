...
import 'package:seedeal02/widgets/tabpostdeal/TabAddImagePage.dart';
...
// Tab#1) Add Imaage
//==========================================================================  
        tabIndex == 0 ? Navigator.push(context, MaterialPageRoute(builder: (context) => TabAddImagePage()),):
        tabIndex == 1 ? TabAddDetail():
        tabIndex == 2 ? TabAddContact():      
        tabIndex == 3 ? TabAddDelivery(): Container(),    
